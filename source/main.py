...
async def get_manifest():
    return {
        ...
        "description": "Willou Elevate your Stremio experience with seamless access to Jackett torrent links, effortlessly "
...
async def update_app():
    try:
        ...
        url = "https://api.github.com/repos/Willou-Gillou/stremio-jackett-wg/releases/latest"
